...
// test for checking if explorer correctly initialize movies
public class MoviesStreamInitializer {
    ...
    public static InputStream initMovieStream() {
        // joining->toString
        return new ByteArrayInputStream(Arrays.stream(movies).collect(Collectors.joining(System.lineSeparator())).getBytes());
    }
}
