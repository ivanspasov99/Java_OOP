...
import bg.sofia.uni.fmi.mjt.christmas.Christmas;
...
public class ChristmasTest {
	...
	public static void setUp() {
		c10 = new Christmas(new WorksShop(), 10, 200);
		c10.celebrate();

		c100 = new Christmas(new WorksShop(), 100, 1000);
		c100.celebrate();

		c1000 = new Christmas(new WorksShop(), 1000, 500);
		c1000.celebrate();

		c10000 = new Christmas(new WorksShop(), 10000, 1000);
		c10000.celebrate();
	}
